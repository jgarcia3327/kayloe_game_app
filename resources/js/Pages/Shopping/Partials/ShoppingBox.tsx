...
export default function ShoppingBox({ auth, shoppingItems }:{
    ...
    return (
        <div className="columns-1 md:columns-2 lg:columns-2 gap-68">
            {shoppingItems.map((item: ShoppingItemProps) => 
                <div 
                    key={item.id}
                            ...
                            <div className="grid grid-cols-4 w-full pt-8 gap-3">
                                {true ? (
                                    <a 
                                        ...
                                        // href={route("shopping.buyticket", item.id).toString()}
                                        href="#"
                                    >
                                        Buy ticket
                                    </a>
                                ...
                                <>
                                    <a className="col-span-2 text-center bg-green-300 rounded-md" href={route('shopping.edit', item.id)}>Edit</a>
                                </>
                                }
                            </div>
                        </div>
